...
def Model_GCN(X, Y, test_X, test_Y, BS=32):
    n_nodes = 10
    n_features = 100
    n_classes = Y.shape[-1]
    ...
    model.fit([Train_X, train_adjacency], Y, epochs=50, batch_size=BS, steps_per_epoch=10, validation_data=([Test_X, test_adjacency], test_Y))
